...
import co.unicauca.proyectobase.controladores.util.VistasEstudiante;
import co.unicauca.proyectobase.entidades.Archivo;
import co.unicauca.proyectobase.entidades.ArchivoPK;
...
public class DocumentacionController implements Serializable {
    ...
    @EJB
    private co.unicauca.proyectobase.facades.DocumentacionFacade ejbFacade;
