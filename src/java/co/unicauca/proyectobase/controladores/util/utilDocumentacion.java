...
public class utilDocumentacion {
    ...
    public final String VISADO_EN_ESPERA = "en espera";
    public final String VISADO_REVISADO = "revisada";
...
//        String tipoDoc = documentacion.getIdTipoPublicacion().getNombre();
        ...
        if (!ArchivoPDF.getFileName().equalsIgnoreCase("")) {
            ...
            articulo.setArchivoIS(ArchivoPDF.getInputstream());
        ...
        for (int i = 0; i < subidaArchivos.size(); i++) {
            ...
            try {
                ...
                PdfAWriter writer = PdfAWriter.getInstance(document, new FileOutputStream(
                        subidaArchivos.get(i).getRutaArchivo()), PdfAConformanceLevel.PDF_A_1B);
                writer.setTagged();
                ...
                reader = new PdfReader(subidaArchivos.get(i).getArchivoIS());
    ...
    public void SubirOpenKM(ArrayList<TipoPDF_cargar> listaArchivos, String estampaTiempo,
